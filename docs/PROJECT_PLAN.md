...
| 1 | audit-01-architecture | 5-layer split honored? Routers route, chapters atomic, INDEX accurate, counts true? | 0 | planned |
| 2 | audit-02-token-cost | Token-efficiency claim holds? Measure router/chapter sizes; LC1 if authorized. | 0 | planned |
