...
The open queue (pre-launch checklist + bias-audit residue + remaining A1, A2.3/A2.4, A4, A12) lives in [`FIXES.md`](FIXES.md).
...
- `chapters/foundations/04a-model-tiers.md` + `global/stacks/*/CLAUDE.md.template` — model IDs replaced with pointers at `docs/MODELS.md` to prevent date-rot.
