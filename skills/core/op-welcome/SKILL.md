...
>
> claude-spine is an operating-discipline layer for Claude Code — 23 skills, 10 slash commands, and a chapter library that loads on demand. Everything is already linked into `~/.claude/`, ready to use.
>
