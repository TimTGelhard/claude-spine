...
|---|---|
| How does Claude Code actually work? What's the loop? | `/Users/macbook/claude-op-manual/chapters/foundations/01a-llm-loop.md` |
| What are the three levers on output quality? | `/Users/macbook/claude-op-manual/chapters/foundations/01b-three-levers.md` |
| Why is Claude drifting / hallucinating / losing focus? Which failure mode is this? | `/Users/macbook/claude-op-manual/chapters/foundations/01c-failure-modes.md` |
| How does the 1M context window really behave? When do I restart? | `/Users/macbook/claude-op-manual/chapters/foundations/02-context-budget.md` |
| What can Claude *not* do, structurally? | `/Users/macbook/claude-op-manual/chapters/foundations/03a-hard-limits.md` |
| What does Claude do unreliably (debugging state, perf, multi-process)? | `/Users/macbook/claude-op-manual/chapters/foundations/03b-soft-limits.md` |
| Does this project type fit Claude well? Warning signs we've hit a limit? | `/Users/macbook/claude-op-manual/chapters/foundations/03c-project-fit.md` |
| Which model — Opus, Sonnet, Haiku — for this task? | `/Users/macbook/claude-op-manual/chapters/foundations/04a-model-tiers.md` |
| Is plan mode / fast mode worth using here? | `/Users/macbook/claude-op-manual/chapters/foundations/04b-plan-and-fast-mode.md` |
| Plan budget, context cost discipline, when NOT to use Claude Code | `/Users/macbook/claude-op-manual/chapters/foundations/04c-budget-and-cost.md` |
