...
A vertical slice that touches all layers (UI → API → DB) and delivers user-visible value or completes a clear technical objective.
...
More than one feature — split these:
...
These aren't hard limits — they're where quality starts slipping. "Too much" doesn't mean impossible; it means you're paying for it in correctness bugs and re-work later.
