...
> **Worked example.** This is `templates/DEPLOY.md` filled in for Next.js on Vercel + Supabase Cloud + a static-client-site VPS variant. The stack-agnostic runbook shape lives at `templates/DEPLOY.md`; use this filled version as a copy/paste starting point if your stack matches.
>
