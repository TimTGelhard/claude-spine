...
> **Worked example.** This is `templates/CLAUDE.md` filled in for a Next.js + Supabase + Stripe quote-management SaaS. The stack-agnostic shape lives at `templates/CLAUDE.md`; use this filled version as a copy/paste starting point if your project matches.
>
