...
> **Worked example.** This is `templates/FEATURES.md` filled in with sample backlog rows from a Next.js + Supabase quote-management SaaS. The stack-agnostic backlog template lives at `templates/FEATURES.md`; use this filled version as a reference for what good sizing + ordering looks like.
>
