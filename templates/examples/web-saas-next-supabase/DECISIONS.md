...
> **Worked example.** This is `templates/DECISIONS.md` filled in with sample ADRs from a Next.js + Supabase + tradespeople-quote-management context. The stack-agnostic ADR template lives at `templates/DECISIONS.md`; use this filled version as a reference for what good ADR shape looks like.
>
