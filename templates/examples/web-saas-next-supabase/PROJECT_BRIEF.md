...
> **Worked example.** This is `templates/PROJECT_BRIEF.md` filled in with sample answers from a quote-management SaaS for tradespeople. The stack-agnostic brief template lives at `templates/PROJECT_BRIEF.md`; use this filled version as a copy/paste starting point if your project is a similar product shape.
>
