...
> **Worked example.** This is `templates/SMOKE_TESTS.md` filled in for a Next.js + Supabase auth-app shape (signup, login, CRUD, RLS isolation, signout). The stack-agnostic shape lives at `templates/SMOKE_TESTS.md`; use this filled version as a copy/paste starting point if your project matches.
>
