...
> **Worked example.** This is `templates/ARCHITECTURE.md` filled in for a Next.js + Supabase + Stripe quote-management SaaS. The stack-agnostic shape lives at `templates/ARCHITECTURE.md`; use this filled version as a copy/paste starting point if your project matches.
>
